...
function Project({
    ...
    return (
        <div className={`h-screen md:h-[28rem] flex items-center w-full
            max-w-screen-lg py-20 px-20 text-neutral-50 md:odd:flex-row-reverse
            border-b last:border-none flex-col md:flex-row gap-16
        `}>
            <div className="h-1/2 w-full md:h-3/4 md:w-1/2 flex flex-col items-start justify-center gap-8 md:gap-4">
